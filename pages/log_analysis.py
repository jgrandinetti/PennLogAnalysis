...
def plot_heatmaps_to_buffer(calculated_fluence, expected_fluence, gamma):
    ...
    trace1 = go.Heatmap(z=calculated_fluence, colorscale='Jet', showscale=False)
    fig.add_trace(trace1, row=1, col=1)

    # Plot expected fluence heatmap
    trace2 = go.Heatmap(z=expected_fluence, colorscale='Jet', showscale=False)
    fig.add_trace(trace2, row=1, col=2)

    # Plot gamma heatmap
    trace3 = go.Heatmap(z=gamma, colorscale='Jet', showscale=False)
